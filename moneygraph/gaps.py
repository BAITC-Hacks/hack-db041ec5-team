...
def next_requests(F, R, P, cfg):
    ...
    requests = [
        ('Расширить обход на 5-е колено', F.is_frontier & (((amount > 0) & (amount >= amount.quantile(c['frontier_quantile']))) | (R.role == 'consolidator')),
        ...
        ('Запросить операции без порога 5 000 KZT', P['rank'] <= c['top_k'],
